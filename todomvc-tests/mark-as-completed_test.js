...
Scenario('Unmark completed todos @T11667032', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T103dcfdf', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @Te85b0bcd', async ({ I, TodosPage }) => {
