...
Feature('@first Create Tasks @step:06 @smoke @story:12345 @S2acde259')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item @Te0337fb8', async ({ I, TodosPage }) => {
...
Scenario('Create ouch another new todo item @Tc38e5335', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('No todo @T734871a8', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Create another one plus new todo item @Tb7105b90', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Create multiple todo items @T4fe339f2', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters @T3c513089', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item @T15e3e6e1', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed @T7b0a688b', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list @T0f309b4f', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs @T6bb887d3', async ({ I, TodosPage }) => {
